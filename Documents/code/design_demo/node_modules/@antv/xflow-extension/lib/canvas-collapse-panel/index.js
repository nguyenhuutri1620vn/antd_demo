...
var NsNodeCollapsePanel = (0, tslib_1.__importStar)(require("./interface"));
...
var CollapsePanelMain = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(panel_body_1.CollapsePanelBody, (0, tslib_1.__assign)({}, props, { state: state, style: bodyStyle, onActiveKeyChange: onActiveKeyChange })),
...
var NodeCollapsePanel = function (props) {
    ...
    return (react_1.default.createElement(base_panel_1.WorkspacePanel, (0, tslib_1.__assign)({}, props, { className: prefixClz, position: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, position), { left: !isCollapsed ? left : -width }), style: { transition: 'left 0.5s' } }),
        react_1.default.createElement(CollapsePanelMain, (0, tslib_1.__assign)({}, props, { prefixClz: prefixClz })),
        collapsible && (react_1.default.createElement(panel_collapse_btn_1.NodePanelCollapseBtn, (0, tslib_1.__assign)({}, props, { prefixClz: prefixClz, isCollapsed: isCollapsed, onCollapseBtnClick: handleBtnClick, style: {
                position: 'absolute',
                zIndex: 1,
                width: 13,
                right: -13,
